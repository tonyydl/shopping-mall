...
android {
    namespace = "com.tonyydl.shoppingmallapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.tonyydl.shoppingmallapp"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.lifecycle:lifecycle-runtime-compose:$composeVersion")
